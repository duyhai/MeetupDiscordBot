...
const strings = {
  welcomeMsg: (
    ...
    `Welcome ${user.toString()}. Have fun exploring the server! Check out some of our interest channels! ${discussionJoinChannel.toString()} ${interestJoinChannel.toString()}`,
  replyToModerator:
